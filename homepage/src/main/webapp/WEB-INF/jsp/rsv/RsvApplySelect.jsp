							...
							<c:choose>
								<c:when test="${result.confmSeCode eq 'R'}">
									<tr>
										...
										<td><input type="text" id="chargerNm" name="chargerNm" title="예약자명" value="<c:out value="${result.chargerNm}"/>" />
										</td>
									</tr>
									<tr>
										<th scope="row">* 연락처</th>
										<td><input type="text" id="telno" name="telno" title="연락처" value="<c:out value="${result.telno}"/>" /></td>
									</tr>
									<tr>
										<th scope="row">이메일</th>
										<td><input type="text" id="email" name="email" title="이메일" value="<c:out value="${result.email}"/>" /></td>
									</tr>
								</c:when>
								<c:otherwise>
									<tr>
